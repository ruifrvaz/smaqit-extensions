...
6. `AGENTS.md` (canonical — read by Codex, Claude Code, and GitHub Copilot) or `CLAUDE.md` (Claude-only additions) — project conventions and deployment path
...
- **Backup script path correctness requires cross-referencing** — compare any hardcoded deployment path in the backup script against the actual path declared in project documentation (`project-recap.md`, `AGENTS.md`, `CLAUDE.md`, or equivalent)

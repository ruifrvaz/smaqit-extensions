...
2. **Project instructions** — read `AGENTS.md` (canonical — read by Codex, Claude Code, and GitHub Copilot) or `CLAUDE.md` (Claude-only additions) if present. Extract any tools, services, or platforms described as part of the project's infrastructure or stack.

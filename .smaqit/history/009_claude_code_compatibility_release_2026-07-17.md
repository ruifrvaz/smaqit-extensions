...
- Researched two reference implementations (`iodis-crm-poc`, `smaqit`) to understand a proven dual-target install pattern before designing this repo's own version
